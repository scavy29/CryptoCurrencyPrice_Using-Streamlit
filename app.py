...
# Creating custom data  for rounding values
...
# Widget (CryptoCurrency Tool Box)
...
# select price change percent column
...
# Create metrics price box
col1.metric(col1_selection,col1_price,col1_percent)
col2.metric(col1_selection,col1_price,col2_percent)
col3.metric(col1_selection,col1_price,col3_percent)
col1.metric(col1_selection,col1_price,col1_percent)
col2.metric(col1_selection,col1_price,col2_percent)
col3.metric(col1_selection,col1_price,col3_percent)
col1.metric(col1_selection,col1_price,col1_percent)
